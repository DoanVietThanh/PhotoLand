...
const Header = () => {
  ...
  return (
    <header className='bg-primary py-6 fixed w-full z-40 lg:relative xl:mb-[30px]'>
        ...
        <div className='flex flex-row gap-4 lg:items-center justify-between mb-4 lg:mb-0'>
          ...
          <div className='flex items-center gap-x-[10px]'>
            ...
            >
              ...
              <div
                className='bg-accent text-primary w-[18px] h-[18px] rounded-full absolute
              top-3 -right-1 text-[13px] flex justify-center items-center font-bold tracking-[-0.1em]'
              >
                {itemsAmount}
              </div>
            </div>
